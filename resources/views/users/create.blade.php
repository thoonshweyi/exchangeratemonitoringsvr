                       ...
                       <div class="col-md-12 col-sm-12 col-md-12">
                        ...
                        <div class="col-md-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="employee_id" value="{{ old('employee_id') }}" class="form-control" placeholder="Employee ID">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="ph_no" value="{{ old('ph_no') }}" class="form-control" placeholder="Phone No">
                            </div>
                        </div>
